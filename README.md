...
- **Edit folder colors…** or **Edit file colors…** chooses independent text and background effects. Folders can cascade either effect and add a subtree border. Draft changes preview directly in the file explorer; Save keeps them and Cancel restores the saved rule.
